package com.reza.mymvvm.util.permission
...
class PermissionUtil {
    ...
    constructor(activity: Activity, fragment: Fragment, permissions: Array<String>, requestCode: Int) {
        ...
        checkPermissionsRegisteredInManifest()
    }
    ...
    private fun checkPermissionsRegisteredInManifest() {
    ...
    fun request(permissionCallback: PermissionCallback?) {
        ...
        if (!hasPermission()) {
            ...
            logDebug("PERMISSION: Permission Granted")
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (denied) {
                ...
                if (!showRational && !currentShowRational) {
                    logDebug( "PERMISSION: Permission Denied By System")

                    mPermissionCallback?.onPermissionDeniedBySystem()
                    deniedCallback(true)
                } else {
                    logDebug( "PERMISSION: Permission Denied")
